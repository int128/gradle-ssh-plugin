...
class SshPluginSpec extends Specification {
    ...
    def "apply the full monty"() {
        ...
        then:
        project.ssh.knownHosts == ConnectionSettings.DEFAULT.allowAnyHosts
    ...
    def "invoke sshexec"() {
        ...
        then: 1 * service.execute(new CompositeSettings(
                connectionSettings: new ConnectionSettings(knownHosts: ConnectionSettings.DEFAULT.allowAnyHosts)
        ), _)
    }
